...
public class AppResponse extends AbstractResult implements Serializable {
    ...
    public Result whenCompleteWithContext(BiConsumer<Result, Throwable> fn) {
        throw new UnsupportedOperationException("AppResponse represents an concrete business response, there will be no status changes, you should get META-INF.dubbo.internal values directly.");
    }
